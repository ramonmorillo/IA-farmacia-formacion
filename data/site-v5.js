(function () {
  ...
  data.meta.version = '5.1.0';
  data.meta.updatedAt = '2026-09-11';
  data.meta.reviewed = '2026-09-11';
  data.meta.tagline = 'Aula y formación aplicada';
  data.meta.valueProposition = 'Enseñar e incorporar inteligencia artificial a la práctica farmacéutica con criterio profesional, evidencia, seguridad y resultados evaluables.';
  ...
  if (notebook) {
    ...
    notebook.guidedPractice = {title:'Práctica guiada', instructions:'Cree un cuaderno con tres documentos públicos o ficticios, solicite una síntesis y verifique cinco afirmaciones contra los pasajes originales.'};
    notebook.independentPractice = {title:'Práctica autónoma', instructions:'Diseñe un protocolo de uso de NotebookLM para preparar una sesión clínica o una revisión documental del servicio.'};
